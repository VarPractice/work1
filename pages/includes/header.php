    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Maritz Dashboard 1.0</a>
            </div>
            <!-- /.navbar-header End -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="#"><i class="fa fa-user fa-fw"></i> <?php echo $_SESSION['user_auth_id']; ?></a>
                        </li>
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                         ...
                         <!-- Log Status -->
                        <li>
                            <a href="log_status.php"><i class="fa fa-edit fa-fw"></i> Log Status</a>
                        </li>
                        <!-- View Stats -->
                        <li>
                            <a href="tables.php"><i class="fa fa-table fa-fw"></i> View Current Stats</a>
                        </li>
                        <!-- Quick Check -->
                        <li>
...
?>
                        ...
                        <!-- Report -->
                        <li class="disabled">
                            <a class="disabled" href="reports.php"> <i class="fa fa-signal fa-fw"></i> Reports</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
